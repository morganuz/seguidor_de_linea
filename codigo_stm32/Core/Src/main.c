...
/**
  ...
  *
  ******************************************************************************
  Pines Motor izquierdo: M0 - PD7, M1 -PB4, Vel - PB6
  Pines Motor derecho: M0 - PB3, M1 - PB5, Vel - PB7
...
/* USER CODE BEGIN PV */
int cambioSensorIzqAsc = 0, cambioSensorDerAsc = 0;
int cambioSensorIzqDesc = 0, cambioSensorDerDesc = 0;
/* USER CODE END PV */
