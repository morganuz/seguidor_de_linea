...
#define SCVI_STATECHART_MAIN_REGION_RECTO 0
#define SCVI_STATECHART_MAIN_REGION_GIRARDER 0
#define SCVI_STATECHART_MAIN_REGION_GIRARIZQ 0
#define SCVI_STATECHART_MAIN_REGION_RETROCESO 0
...
typedef enum  {
	...
	Statechart_sensorIzqON,
	Statechart_sensorIzqOFF,
	Statechart_sensorDerON,
	Statechart_sensorDerOFF,
	Statechart_ambosSensoresOFF,
	Statechart_ambosSensoresON
} StatechartEventID;
...
typedef enum
{
	...
	Statechart_main_region_recto,
	Statechart_main_region_girarDer,
	Statechart_main_region_girarIzq,
	Statechart_main_region_retroceso
} StatechartStates;
...
{
	sc_boolean sensorIzqON_raised;
	sc_boolean sensorIzqOFF_raised;
	sc_boolean sensorDerON_raised;
	sc_boolean sensorDerOFF_raised;
	sc_boolean ambosSensoresOFF_raised;
	sc_boolean ambosSensoresON_raised;
};
...
/*! Raises the in event 'sensorIzqON' that is defined in the default interface scope. */ 
extern void statechart_raise_sensorIzqON(Statechart* handle);
/*! Raises the in event 'sensorIzqOFF' that is defined in the default interface scope. */ 
extern void statechart_raise_sensorIzqOFF(Statechart* handle);
/*! Raises the in event 'sensorDerON' that is defined in the default interface scope. */ 
extern void statechart_raise_sensorDerON(Statechart* handle);
/*! Raises the in event 'sensorDerOFF' that is defined in the default interface scope. */ 
extern void statechart_raise_sensorDerOFF(Statechart* handle);
/*! Raises the in event 'ambosSensoresOFF' that is defined in the default interface scope. */ 
extern void statechart_raise_ambosSensoresOFF(Statechart* handle);
/*! Raises the in event 'ambosSensoresON' that is defined in the default interface scope. */ 
extern void statechart_raise_ambosSensoresON(Statechart* handle);
